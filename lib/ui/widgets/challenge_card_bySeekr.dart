...
class FeaturedChallengeBySeekr extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: new FutureBuilder<List<Movie>>(
            future: challengesHelper.getDataSeekr(),
            builder: (context, snapshot) {
              if (snapshot.hasError) print(snapshot.error);
              return snapshot.hasData
                  ? new ChallengeSeekrList(
                      list: snapshot.data,
                    )
                  : new Center(
...
class ChallengeSeekrList extends StatelessWidget {
  List<Movie> list;
  ChallengeSeekrList({this.list});

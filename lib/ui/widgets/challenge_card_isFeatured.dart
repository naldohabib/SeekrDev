...
class FeaturedChallengeIsFeatured extends StatelessWidget {
  // final Function onTap;

  // FeaturedChallengeBySeekr({this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: new FutureBuilder<List<Movie>>(
            future: challengesHelper.getDataIsFeatured(),
            builder: (context, snapshot) {
              if (snapshot.hasError) print(snapshot.error);
              return snapshot.hasData
                  ? new ChallengeIsFeaturedList(
                      list: snapshot.data,
                    )
                  : new Center(
...
class ChallengeIsFeaturedList extends StatelessWidget {
  List<Movie> list;
  ChallengeIsFeaturedList({this.list});

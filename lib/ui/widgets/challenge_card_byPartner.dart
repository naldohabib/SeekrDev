...
class FeaturedChallengeByPartner extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: new FutureBuilder<List<Movie>>(
            future: challengesHelper.getDataPartner(),
            builder: (context, snapshot) {
              if (snapshot.hasError) print(snapshot.error);
              return snapshot.hasData
                  ? new ChallengePartnerList(
                      list: snapshot.data,
                    )
                  : new Center(
...
class ChallengePartnerList extends StatelessWidget {
  List<Movie> list;
  ChallengePartnerList({this.list});
